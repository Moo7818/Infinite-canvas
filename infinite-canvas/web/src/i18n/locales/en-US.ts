export default {
    ...
    config: {
        ...
        channelEditor: {
            ...
            modelDescription: "{{count}} selected; assign a capability, image parameters, and optionally a request script to each model.",
            selectModels: "Select models",
            scriptReady: "Script set",
            script: "Request script",
            imageParams: "Image params",
            imageParamsReady: "Image params set",
            sizeMode: { sizeModeLabel: "Size control mode", auto: "Auto", ratio: "Ratio", pixels: "Pixels", ratioOrPixels: "Ratio or pixels" },
            imageParamsModal: { title: "Image parameters", hint: "Render node parameter pickers according to the aspectRatio/size field the model API actually accepts", pixelPresets: "Pixel presets (comma-separated, e.g. 1024x1024,2048x2048)", aspectPresets: "Aspect buttons (comma-separated, optional; leave empty for the built-in list)" },
