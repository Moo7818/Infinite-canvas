export default {
    ...
    settingsPanels: {
        ...
        image: { title: "图像设置", quality: "质量", size: "尺寸", align16: "16 倍数对齐", align16Hint: "输入完成后自动向上补成 16 的倍数", aspectRatio: "宽高比", pixelPresets: "像素档位", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", count: "生成张数", images: "{{count}} 张" },
    ...
    config: {
        ...
        channelEditor: {
            ...
            baseUrl: "接口地址",
            models: "渠道模型",
            modelDescription: "已选 {{count}} 个；为每个模型指定能力、图像参数与自定义调用脚本。",
            selectModels: "选择模型",
            scriptReady: "脚本已设",
            script: "调用脚本",
            imageParams: "图像参数",
            imageParamsReady: "图像参数已设",
            sizeMode: { sizeModeLabel: "尺寸控件模式", auto: "自动", ratio: "比例", pixels: "像素", ratioOrPixels: "比例或像素" },
            imageParamsModal: { title: "图像参数", hint: "按模型接口实际支持的 aspectRatio/尺寸字段渲染节点参数选择器", pixelPresets: "像素档位（逗号分隔，如 1024x1024,2048x2048）", aspectPresets: "比例按钮（逗号分隔，可选；留空使用内置列表）" },
