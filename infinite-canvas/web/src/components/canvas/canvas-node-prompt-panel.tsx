                ...
                <div className="flex min-w-0 items-center gap-2">
                    ...
                    {mode === "image" ? (
                        ...
                        <>
                            ...
                            <CanvasVideoSettingsPopover config={config} buttonClassName="!h-10 !max-w-[170px] !justify-start !rounded-full !px-3" onConfigChange={(key, value) => onConfigChange(node.id, videoConfigPatch(key, value))} onCustomParamsChange={(key, value) => onConfigChange(node.id, { customParams: { ...(node.metadata?.customParams || {}), [key]: value } })} />
                        </>
                    ) : mode === "audio" ? (
                        <>
